...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(176, 38, 84));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(53, 180, 74));
        ...
        panel3.setBackground(new Color(92, 113, 215));


        //panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(140, 112, 187));
